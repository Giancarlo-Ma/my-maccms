<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"/var/www/html/application/admin/view/collect/info.html";i:1617440624;s:53:"/var/www/html/application/admin/view/public/head.html";i:1617440624;s:53:"/var/www/html/application/admin/view/public/foot.html";i:1617440624;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" method="post" action="">
        ...
        <div class="layui-form-item row_filer" <?php if($info['collect_mid'] != '1'): ?> style="display:none;" <?php endif; ?>>
            ...
            <div class="layui-input-block">
                ...
                <input name="collect_filter" type="radio" value="1" title="<?php echo lang('admin/collect/add'); ?>" <?php if($info['collect_filter'] == 2): ?>checked <?php endif; ?>>
                <input name="collect_filter" type="radio" value="2" title="<?php echo lang('admin/collect/update'); ?>" <?php if($info['collect_filter'] == 3): ?>checked <?php endif; ?>>
            </div>
        </div>
        <div class="layui-form-item row_filer" <?php if($info['collect_mid'] != '1'): ?> style="display:none;" <?php endif; ?>>
