...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_630ce8b087694=explode(',',$maccms['search_hot']); if(is_array($_630ce8b087694) || $_630ce8b087694 instanceof \think\Collection || $_630ce8b087694 instanceof \think\Paginator): if( count($_630ce8b087694)==0 ) : echo "" ;else: foreach($_630ce8b087694 as $key2=>$vo2): ?>
