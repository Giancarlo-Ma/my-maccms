<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:38:"template/default_pc/html/vod/type.html";i:1617440624;s:58:"/var/www/html/template/default_pc/html/public/include.html";i:1617440624;s:55:"/var/www/html/template/default_pc/html/public/head.html";i:1617440624;s:57:"/var/www/html/template/default_pc/html/public/paging.html";i:1617440624;s:55:"/var/www/html/template/default_pc/html/public/foot.html";i:1617440624;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_630cea0f74b88=explode(',',$maccms['search_hot']); if(is_array($_630cea0f74b88) || $_630cea0f74b88 instanceof \think\Collection || $_630cea0f74b88 instanceof \think\Paginator): if( count($_630cea0f74b88)==0 ) : echo "" ;else: foreach($_630cea0f74b88 as $key2=>$vo2): ?>
    ...
    <ul class="directory-list">
        <li>
            <dl class="leixing">
                ...
                <?php if(empty($obj['type_extend']['class']) || (($obj['type_extend']['class'] instanceof \think\Collection || $obj['type_extend']['class'] instanceof \think\Paginator ) && $obj['type_extend']['class']->isEmpty())): $_630cea0f74b5a=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_630cea0f74b5a) || $_630cea0f74b5a instanceof \think\Collection || $_630cea0f74b5a instanceof \think\Paginator): if( count($_630cea0f74b5a)==0 ) : echo "" ;else: foreach($_630cea0f74b5a as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_630cea0f74b55=explode(',',$obj['type_extend']['class']); if(is_array($_630cea0f74b55) || $_630cea0f74b55 instanceof \think\Collection || $_630cea0f74b55 instanceof \think\Paginator): if( count($_630cea0f74b55)==0 ) : echo "" ;else: foreach($_630cea0f74b55 as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
        ...
        <li>
            <dl class="area">
                ...
                <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_630cea0f74b48=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_630cea0f74b48) || $_630cea0f74b48 instanceof \think\Collection || $_630cea0f74b48 instanceof \think\Paginator): if( count($_630cea0f74b48)==0 ) : echo "" ;else: foreach($_630cea0f74b48 as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_630cea0f74b42=explode(',',$obj['type_extend']['area']); if(is_array($_630cea0f74b42) || $_630cea0f74b42 instanceof \think\Collection || $_630cea0f74b42 instanceof \think\Paginator): if( count($_630cea0f74b42)==0 ) : echo "" ;else: foreach($_630cea0f74b42 as $key=>$vo): ?>
        ...
        <li>
            <dl>
                ...
                <?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_630cea0f74b33=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_630cea0f74b33) || $_630cea0f74b33 instanceof \think\Collection || $_630cea0f74b33 instanceof \think\Paginator): if( count($_630cea0f74b33)==0 ) : echo "" ;else: foreach($_630cea0f74b33 as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_630cea0f74b2a=explode(',',$obj['type_extend']['year']); if(is_array($_630cea0f74b2a) || $_630cea0f74b2a instanceof \think\Collection || $_630cea0f74b2a instanceof \think\Paginator): if( count($_630cea0f74b2a)==0 ) : echo "" ;else: foreach($_630cea0f74b2a as $key=>$vo): ?>
