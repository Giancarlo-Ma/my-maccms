<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"template/default_pc/html/index/index.html";i:1617440624;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="markdown-body" style="padding:40px;">
    ...
    <blockquote>
        <p>
            本程序仅供内部学习和交流使用，没有内置任何数据，请在遵守当地法律的前提下使用本站程序!<br>
    ...
    <blockquote>
        <p>
            进入用户中心： <a target="_blank" href="<?php echo mac_url('user/index'); ?>"><?php echo mac_url('user/index'); ?></a><br>
        </p>
    </blockquote>
